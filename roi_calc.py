...
class Calculating():
    ...
    def total_income(self):  
        ...
        while True:
            ...
            while True:
                if check == 'y':
                    print(f"Excellent, {self.name}. Let us proceed.")
                    break
                elif check == 'n':
    ...
    def cash_flow(self, income, expense):
        flow = income - expense
...
class Main:
    ...
    def run():
        ...
        expense = calc.expenses()
        flow = calc.cash_flow(income, expense)
        calc.cash_return(flow)
